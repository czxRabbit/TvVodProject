...
import com.ts.cyd.tsreplay.JSONStringerg;
...
public class JSONObject {
    ...
    @Override public String toString() {
        try {
            JSONStringerg stringer = new JSONStringerg();
            writeTo(stringer);
    ...
    public String toString(int indentSpaces) throws JSONException {
        JSONStringerg stringer = new JSONStringerg(indentSpaces);
        writeTo(stringer);
        return stringer.toString();
    }

    void writeTo(JSONStringerg stringer) throws JSONException {
        stringer.object();
    ...
    public static String quote(String data) {
        ...
        try {
            JSONStringerg stringer = new JSONStringerg();
            stringer.open(JSONStringerg.Scope.NULL, "");
            stringer.value(data);
            stringer.close(JSONStringerg.Scope.NULL, JSONStringerg.Scope.NULL, "");
            return stringer.toString();
        } catch (JSONException e) {
