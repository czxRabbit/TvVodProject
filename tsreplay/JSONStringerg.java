...
/**
 * Implements {@link org.json.JSONObject#toString} and {@link JSONArray#toString}. Most
 ...
 * output. To encode indented output, use {@link org.json.JSONObject#toString(int)} or
...
public class JSONStringerg {
    ...
    enum Scope {
        ...
        /**
         * A special bracketless array needed by JSONStringerg.join() and
    ...
    public JSONStringerg() {
        indent = null;
    }

    JSONStringerg(int indentSpaces) {
     ...
     */
    public JSONStringerg array() throws JSONException {
     ...
     * @return this stringer.
     */
    public JSONStringerg endArray() throws JSONException {
     ...
     * @return this stringer.
     */
    public JSONStringerg object() throws JSONException {
     ...
     * @return this stringer.
     */
    public JSONStringerg endObject() throws JSONException {
     ...
     * bracket.
     */
    JSONStringerg open(Scope empty, String openBracket) throws JSONException {
     ...
     * given bracket.
     */
    JSONStringerg close(Scope empty, Scope nonempty, String closeBracket) throws JSONException {
        Scope context = peek();
     ...
     * Encodes {@code value}.
     *
     * @param value a {@link org.json.JSONObject}, {@link JSONArray}, String, Boolean,
     *     Integer, Long, Double or null. May not be {@link Double#isNaN() NaNs}
     *     or {@link Double#isInfinite() infinities}.
     * @return this stringer.
     */
    public JSONStringerg value(Object value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        ...
        if (value instanceof JSONArray) {
            ...
            //((org.json.JSONObject) value).writeTo(this);
            return this;
        }
        ...
        if (value == null
            ...
            out.append(org.json.JSONObject.numberToString((Number) value));
     ...
     * @return this stringer.
     */
    public JSONStringerg value(boolean value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
     ...
     * @return this stringer.
     */
    public JSONStringerg value(double value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
        out.append(org.json.JSONObject.numberToString(value));
        return this;
    }
     ...
     * @return this stringer.
     */
    public JSONStringerg value(long value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
     ...
     * @return this stringer.
     */
    public JSONStringerg key(String name) throws JSONException {
        if (name == null) {
